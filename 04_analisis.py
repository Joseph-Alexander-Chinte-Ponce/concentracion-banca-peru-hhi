...
Entrada:  /content/datos_procesados_2024200494M.csv
Salidas:  /content/salidas/  (tablas .csv y figuras .png)
"""
...
ENTRADA_CSV = "/content/drive/MyDrive/proyecto_hhi_2024200494M/datos_procesados_2024200494M.csv"
CARPETA_SALIDAS = "/content/drive/MyDrive/proyecto_hhi_2024200494M/salidas"
...
def tabla1_ranking_bancos(panel):
    ...
    ruta = os.path.join(CARPETA_SALIDAS, "tabla1_ranking_bancos.csv")
...
def tabla2_correlaciones(panel):
    ...
    ruta = os.path.join(CARPETA_SALIDAS, "tabla2_correlaciones.csv")
...
def figura1_evolucion_hhi_c4(panel):
    ...
    fig.tight_layout()
    ruta = os.path.join(CARPETA_SALIDAS, "figura1_evolucion_hhi_c4.png")
...
def figura2_hhi_vs_spread(panel):
    ...
    ruta = os.path.join(CARPETA_SALIDAS, "figura2_hhi_vs_spread.png")
    fig.savefig(ruta, dpi=150)
    plt.close(fig)
...
def main():
    ...
    print("\nListo. Revisa /content/salidas: deben existir 2 tablas .csv y 2 figuras .png")
